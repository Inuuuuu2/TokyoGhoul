  ...
  return (
    <>
      ...
      <div className="flex gap-3 md:gap-4 px-3 py-2 md:p-4 border-b border-[#222] bg-[#050505] overflow-x-auto whitespace-nowrap flex-shrink-0">
        ...
        <button onClick={() => st.openRegexes()} className="text-xs md:text-sm font-mono text-ghoul-muted hover:text-white active:text-white transition-colors">🔧 REGEX [{st.regexes.length}]</button>
      ...
      {st.showRegexes && <RegexModal onClose={() => st.setShowRegexes(false)} />}
